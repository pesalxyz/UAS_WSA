...
@foreach($fields as $name => $field)
    @if($name === '[]')
        @php
            $description = "Body request berupa array (<code>{$field['type']}</code>`)";
            $description .= !empty($field['description']) ? ", yang merepresentasikan ".lcfirst($field['description'])."." : '.';
            if(count($field['__fields'])) $description .= " Setiap item memiliki properti berikut:";
        @endphp
