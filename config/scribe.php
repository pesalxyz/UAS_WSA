...
return [
    ...
    'description' => 'REST API mini e-commerce untuk kebutuhan UAS Web Service Application.',

    // Text to place in the "Introduction" section, right after the `description`. Markdown and HTML are supported.
    'intro_text' => <<<'INTRO'
            Dokumentasi ini menjelaskan endpoint autentikasi, kategori, dan produk untuk API mini e-commerce.

            Gunakan endpoint login atau register untuk mendapatkan Bearer token, lalu kirim token tersebut ke endpoint yang dilindungi `auth:sanctum`.
        INTRO,
    ...
    'auth' => [
        ...
        'placeholder' => '{TOKEN_ANDA}',

        // Any extra authentication-related info for your users. Markdown and HTML are supported.
        'extra_info' => 'Ambil token dari endpoint login atau register, lalu kirim sebagai header `Authorization: Bearer {token}`.',
    ],
    ...
    // Note: does not work for `external` docs types
    'last_updated' => 'Terakhir diperbarui: {date:d-m-Y}',
